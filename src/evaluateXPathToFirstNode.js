 ...
 */
export default function evaluateXPathToFirstNode (selector, contextNode, domFacade, variables) {
	return /** @type {!Node} */ (evaluateXPath(selector, contextNode, domFacade, variables, evaluateXPath.FIRST_NODE_TYPE));
}
