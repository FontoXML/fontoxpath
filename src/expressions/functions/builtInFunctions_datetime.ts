...
const declarations: BuiltinDeclarationType[] = [
	{
		...
		localName: 'dateTime',
		argumentTypes: [
			{ kind: BaseType.XSDATE, seqType: SequenceMultiplicity.ZERO_OR_ONE },
			{ kind: BaseType.XSTIME, seqType: SequenceMultiplicity.ZERO_OR_ONE },
		],
	...
	},
	{
		...
		argumentTypes: [{ kind: BaseType.XSDATETIME, seqType: SequenceMultiplicity.ZERO_OR_ONE }],
	...
	},
	{
		...
		argumentTypes: [{ kind: BaseType.XSDATE, seqType: SequenceMultiplicity.ZERO_OR_ONE }],
		returnType: { kind: BaseType.XSINTEGER, seqType: SequenceMultiplicity.ZERO_OR_ONE },
		callFunction: fnYearFromDateTime,
	},
	{
	...
	},
	{
		...
		argumentTypes: [{ kind: BaseType.XSTIME, seqType: SequenceMultiplicity.ZERO_OR_ONE }],
		returnType: { kind: BaseType.XSINTEGER, seqType: SequenceMultiplicity.ZERO_OR_ONE },
		callFunction: fnHoursFromDateTime,
	},
	{
