			...
			return createDoublyIterableSequence(
				itemFunctionValue.value.call(
					...
					transformArgumentList(
						itemFunctionValue.getArgumentTypes() as ParameterValueType[],
						[member()],
						executionParameters,
						'array:for-each'
					)[0]
...
const declarations: BuiltinDeclarationType[] = [
	{
		...
		localName: 'size',
		argumentTypes: [{ kind: BaseType.ARRAY, items: [], seqType: ParameterType.EXACTLY_ONE }],
...

	{
		...
		localName: 'get',
		argumentTypes: [
			{ kind: BaseType.ARRAY, items: [], seqType: ParameterType.EXACTLY_ONE },
			{ kind: BaseType.XSINTEGER, seqType: ParameterType.EXACTLY_ONE },
		],
...

	{
		...
		argumentTypes: [
			{ kind: BaseType.ARRAY, items: [], seqType: ParameterType.EXACTLY_ONE },
			{ kind: BaseType.XSINTEGER, seqType: ParameterType.EXACTLY_ONE },
			{ kind: BaseType.ITEM, seqType: ParameterType.ZERO_OR_MORE },
		],
...

	{
		...
		argumentTypes: [
			{ kind: BaseType.ARRAY, items: [], seqType: ParameterType.EXACTLY_ONE },
			{ kind: BaseType.XSINTEGER, seqType: ParameterType.ZERO_OR_MORE },
		],
		returnType: { kind: BaseType.ARRAY, items: [], seqType: SequenceType.EXACTLY_ONE },
...

	{
		namespaceURI: ARRAY_NAMESPACE_URI,
		localName: 'join',
		argumentTypes: [{ kind: BaseType.ARRAY, items: [], seqType: ParameterType.ZERO_OR_MORE }],
		returnType: { kind: BaseType.ARRAY, items: [], seqType: SequenceType.EXACTLY_ONE },
...

	{
		...
		argumentTypes: [
			{ kind: BaseType.ARRAY, items: [], seqType: ParameterType.EXACTLY_ONE },
			{
				...
				params: [],
				seqType: ParameterType.EXACTLY_ONE,
			},
		],
		returnType: { kind: BaseType.ARRAY, items: [], seqType: SequenceType.EXACTLY_ONE },
