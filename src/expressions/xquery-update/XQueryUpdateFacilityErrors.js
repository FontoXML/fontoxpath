...
export const errXUTY0022 = () => new Error('XUTY0022: An insert expression specifies the insertion of an attribute node into a document node.');
...
export const errXUDY0027 = () => new Error('XUDY0027: The target for an insert, replace, or rename expression expression should not be empty.');
export const errXUDY0029 = (target) => new Error(`XUDY0029: The target ${target.outerHTML} for inserting a node before or after must have a parent.`);
export const errXUDY0030 = () => new Error('XUDY0030: An insert expression specifies the insertion of an attribute node before or after a child of a document node.');
