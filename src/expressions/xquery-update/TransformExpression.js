...
/** @typedef {{varRef: !QName, sourceExpr: !Expression, registeredVariable: ?string}} */
let VariableBinding;
...
class TransformExpression extends UpdatingExpression {
	 ...
	 */
	constructor (variableBindings, modifyExpr, returnExpr) {
		super(
			new Specificity({}),
	...
	performStaticEvaluation (staticContext) {
		...
		this._variableBindings.forEach(variableBinding =>
			variableBinding.registeredVariable = staticContext.registerVariable(variableBinding.varRef.namespaceURI, variableBinding.varRef.localPart));
