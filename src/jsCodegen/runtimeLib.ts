...
import { acceptAst, GeneratedCodeBaseType, GeneratedCodeType, getCompiledValueCode, PartialCompilationResult } from './JavaScriptCompiledXPath';

export function determinePredicateTruthValue(identifier: string, code: string, type: GeneratedCodeType, contextItem: string = 'contextItem'): PartialCompilationResult {
	switch (type.type) {
