 ...
 */
export default function evaluateXPathToMap (selector, contextNode, domFacade, variables) {
	return /** @type {!Object} */ (evaluateXPath(selector, contextNode, domFacade, variables, evaluateXPath.MAP_TYPE));
};
