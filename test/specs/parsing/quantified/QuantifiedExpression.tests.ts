...
describe('quantified expressions', () => {
	...
	describe('every', () => {
		...
		it('does not throw when a result has been found before errors', () =>
			chai.assert(
				evaluateXPathToBoolean(
					'(every $x in (1, 2, "cat") satisfies 2 * $x = 2) eq false()',
					documentNode
				)
			));
		...
		describe('single variable binding', () => {
			it('returns true if one of the values is true', () =>
				chai.assert(
					evaluateXPathToBoolean('every $x in true() satisfies $x', documentNode)
				));

			it('returns true if none of the values are true', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'(every $x in false() satisfies $x) eq false()',
						documentNode
					)
				));
			...
			it('returns false if passed an empty sequence', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'(every $x in () satisfies true()) eq true()',
						documentNode
					)
				));
			...
			it('Simple quantified expression using "every" keyword and use of logical expression (or).', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'every $x in (1, 2) satisfies $x = 1 or ($x +1) = 3',
						documentNode
					)
				));
		});
		...
		describe('multiple variable binding', () => {
			it('returns true if one the satisfies options returns true', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'every $x in true(), $y in true() satisfies $x = $y',
						documentNode
					)
				));
			...
			it('returns false if none the satisfies options returns true', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'(every $x in (false(), true()), $y in (false(), true()) satisfies $x = $y) eq false()',
						documentNode
					)
				));
		});
	...
	describe('some', () => {
		...
		it('does not throw when a result has been found before errors', () =>
			chai.assert(
				evaluateXPathToBoolean(
					'(some $x in (1, 2, "cat") satisfies 2 * $x = 2) eq true()',
					documentNode
				)
			));
		...
		describe('single variable binding', () => {
			it('returns true if one of the values is true', () =>
				chai.assert(
					evaluateXPathToBoolean('some $x in true() satisfies $x', documentNode)
				));

			it('returns true if none of the values are true', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'(some $x in false() satisfies $x) eq false()',
						documentNode
					)
				));
			...
			it('returns false if passed an empty sequence', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'(some $x in () satisfies true()) eq false()',
						documentNode
					)
				));
		...
		describe('multiple variable binding', () => {
			it('returns true if one the satisfies options returns true', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'some $x in true(), $y in true() satisfies $x = $y',
						documentNode
					)
				));
			it('can re-use variables in further bindings', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'every $x in (1, 2), $y in $x satisfies $y',
						documentNode
					)
				));
			...
			it('returns false if none the satisfies options returns true', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'(some $x in false(), $y in true() satisfies $x = $y) = false()',
						documentNode
					)
				));
			...
			it('return false if one the satisfies option is empty', () =>
				chai.assert(
					evaluateXPathToBoolean(
						'(some $x in (1, 2, 3), $y in () satisfies (fn:exactly-one($x) and fn:exactly-one($y))) = false()',
						documentNode
					)
				));
		});
