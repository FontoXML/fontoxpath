...
describe('Math functions', () => {
	...
	describe('math:exp', () => {
		...
		it('allows async params', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:exp(0 => fontoxpath:sleep()) = 1')
			);
		});
	...
	describe('math:exp10', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:exp10(0 => fontoxpath:sleep()) = 1')
			);
		});
	...
	describe('math:log', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:log(1 => fontoxpath:sleep()) = 0')
			);
		});
	...
	describe('math:log10', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:log10(1 => fontoxpath:sleep()) = 0')
			);
		});
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton(
					'math:pow(1 => fontoxpath:sleep(), 0 => fontoxpath:sleep()) = 1'
				)
			);
		});
	});
	...
	describe('math:sqrt', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:sqrt(25 => fontoxpath:sleep()) = 5')
			);
		});
	});
	...
	describe('math:sin', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:sin(0 => fontoxpath:sleep()) = 0')
			);
		});
	});
	...
	describe('math:cos', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:cos(0 => fontoxpath:sleep()) = 1')
			);
		});
	});
	...
	describe('math:tan', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:tan(0 => fontoxpath:sleep()) = 0')
			);
		});
	});
	...
	describe('math:asin', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:asin(0 => fontoxpath:sleep()) = 0')
			);
		});
	});
	...
	describe('math:acos', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:acos(1 => fontoxpath:sleep()) = 0')
			);
		});
	});
	...
	describe('math:atan', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton('math:atan(0 => fontoxpath:sleep()) = 0')
			);
		});
	});
	...
	describe('math:atan2', () => {
		...
		it('accepts async parameters', async () => {
			chai.assert.isTrue(
				await evaluateXPathToAsyncSingleton(
					'math:atan2(0 => fontoxpath:sleep(), 0 => fontoxpath:sleep()) = 0'
				)
			);
		});
	});
