	...
	describe('axes', function () {
			...
			describe('descendant', function () {
				it('parses descendant::', function () {
					...
					chai.expect(evaluateXPath(selector, documentNode, blueprint)).to.deep.equal([documentNode.firstChild.firstChild]);
				});
			});
			...
			describe('parent', function () {
				it('parses parent::', function () {
					...
					chai.expect(evaluateXPath(selector, documentNode.documentElement.firstChild, blueprint)).to.deep.equal([documentNode.documentElement]);
				});
			});
			...
			describe('following-sibling', function () {
				it('parses following-sibling::', function () {
					...
					chai.expect(evaluateXPath(selector, documentNode.documentElement.firstChild, blueprint)).to.deep.equal([documentNode.documentElement.lastChild]);
				});
			});
			...
			describe('preceding-sibling', function () {
				it('parses preceding-sibling::', function () {
					...
					chai.expect(evaluateXPath(selector, documentNode.documentElement.lastChild, blueprint)).to.deep.equal([documentNode.documentElement.firstChild]);
				});
			});
